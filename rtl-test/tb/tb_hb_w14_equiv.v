// Bit-exact equivalence: sd_decimator_hb_w14 (14-bit CIC) vs sd_decimator_hb_tdm
...
module tb_hb_w14_equiv;
    ...
    sd_decimator_hb_w14 dut (.clk_32m(clk_32m),.rst_n(rst_n),.iq_in_i(iq_in_i),.iq_in_q(iq_in_q),
    ...
    initial begin
        ...
        $display("tb_hb_w14_equiv: PASS (%0d exact packed outputs, %0d cycles)",checks,cycles);
        $finish;
    end
