# Custom PDN config for picorv32_wrap SRAM macros.
# The SRAM macro exposes VDD/VSS on Metal2/Metal3, so the default
# LibreLane macro grid (which only bridges top-level PDN layers) never
# reaches a macro pin layer. This macro grid lands on Metal3 and bridges
# up to the core Metal4/Metal5 grid.
...
define_pdn_grid     -macro     -name macro     -grid_over_pg_pins     -cells "gf180mcu_ocd_ip_sram__sram1024x8m8wm1"     -starts_with POWER     -halo "$::env(PDN_HORIZONTAL_HALO) $::env(PDN_VERTICAL_HALO)"
