// sd_remod_pre_multiplierless_reference.v
//
// FROZEN REFERENCE, not live RTL: this is the pre-promotion (2026-09-05)
// sd_remod core -- general Verilog `*` against the Q8 coefficients, no
// interpolator -- preserved solely so
// rtl-test/tb/tb_sd_remod_multiplierless_equiv.v keeps a stable bit-exact
// reference to compare sd_remod_multiplierless.v against. The module name
// inside is still `sd_remod` (unchanged) so the testbench's instantiation
// needs no edits, only this file's own path in the Makefile dependency.
// src/remod/sd_remod.v is the promoted, canonical module now (interpolator +
// sd_remod_multiplierless core) -- do not confuse this frozen copy with it.
//
