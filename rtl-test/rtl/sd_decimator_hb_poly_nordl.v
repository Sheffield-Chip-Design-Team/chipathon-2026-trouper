...
`timescale 1ns/100ps
module sd_decimator_hb_poly_nordl (
    ...
    always @(*) begin
        ...
        if (!hb1_stream[2]) begin
            ...
            h1a3=h1a_i[s1][3]; h1a4=h1a_i[s1][4]; h1a5=h1a_i[s1][5]; h1bc=h1b_i[s1][2];
        end else begin
            h1a0=h1a_q[s1][0]; h1a1=h1a_q[s1][1]; h1a2=h1a_q[s1][2];
            h1a3=h1a_q[s1][3]; h1a4=h1a_q[s1][4]; h1a5=h1a_q[s1][5]; h1bc=h1b_q[s1][2];
        end
