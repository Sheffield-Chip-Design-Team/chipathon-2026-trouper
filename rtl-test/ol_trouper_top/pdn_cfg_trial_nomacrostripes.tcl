# Custom PDN config for trouper_top SRAM macros.
...
# Trial macro PDN mode: keep only the macro's native lower-layer PG stitch
# and remove generated M4/M5 macro-local stripes. This is a diagnostic run,
# not a new baseline.
...
add_pdn_connect -grid macro_ocd -layers "Metal2 Metal3"
...
add_pdn_connect -grid macro_fd -layers "Metal2 Metal3"
