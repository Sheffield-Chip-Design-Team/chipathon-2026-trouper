...
module fpga_dsp_wrap #(
    ...
    trouper_top u_top (
        ...
        .PSRAM_SCK     (ps_sck),
        .PSRAM_CE_N    (ps_ce_n),
                .PSRAM_SIO_OUT_0 (ps_sio_out[0]),
        .PSRAM_SIO_OUT_1 (ps_sio_out[1]),
        .PSRAM_SIO_OUT_2 (ps_sio_out[2]),
        .PSRAM_SIO_OUT_3 (ps_sio_out[3]),
                .PSRAM_SIO_IN_0 (ps_sio_in[0]),
        .PSRAM_SIO_IN_1 (ps_sio_in[1]),
        .PSRAM_SIO_IN_2 (ps_sio_in[2]),
        .PSRAM_SIO_IN_3 (ps_sio_in[3]),
                .PSRAM_SIO_OE_0 (ps_sio_oe[0]),
        .PSRAM_SIO_OE_1 (ps_sio_oe[1]),
        .PSRAM_SIO_OE_2 (ps_sio_oe[2]),
        .PSRAM_SIO_OE_3 (ps_sio_oe[3]),
        .HOST_CS       (sel_host_cs),
        .SPI_SCK       (sel_spi_sck),
